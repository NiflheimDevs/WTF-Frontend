export default {
  common: {
    ...
    version: "v1.0 · Provincial Crisis HQ",
    footer: "Provincial Crisis HQ · v1.0",
  },
  brand: {
    water: "Water",
    supply: "Supply",
    ...
    waterOps: "WaterOps",
    dispatch: "Dispatch",
    appTitle: "Water Supply Reporting System",
  },
  nav: {
    overview: "Overview",
    requests: "Requests",
  ...
  auth: {
    ...
    signUpSubtitle: "Register as a new dispatcher",
    ...
    backendNotConnected: "Backend not connected yet. Come back soon.",
    emailExists: "An account with this email already exists.",
    passwordTooShort: "Too short",
    passwordFair: "Fair",
    passwordStrong: "Strong",
    emailPlaceholder: "dispatcher@hq.gov",
    namePlaceholder: "Maryam Ahmadi",
  },
  reporter: {
    region: "Region",
