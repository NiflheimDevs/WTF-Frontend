export default {
  ...
  dashboard: {
    ...
    fulfillmentRateCaption: "of resolved requests",
    cancellationRate: "Cancellation Rate",
    cancellationRateCaption: "of all requests",
    avgResponse: "Avg Response",
    avgResponseCaption: "median {{value}}",
    minutesShort: "{{count}} min",
    minutesUnit: "min",
    todayDelta: "+{{count}} today",
    ...
    groupByNeed: "Group by need",
    dispatchFunnel: "Dispatch Funnel",
    funnelPending: "Pending",
    funnelDispatched: "Dispatched",
    funnelFulfilled: "Fulfilled",
    funnelCancelled: "Cancelled",
    stuckRequests: "stuck in dispatch",
    stuckHint: "In dispatched state for over {{hours}}h",
    stuckThreshold: "Stuck after",
    conversionRate: "{{value}}% converted",
    dispatcherLeaderboard: "Top Dispatchers",
    dispatchCount: "Dispatches",
    noDispatcherData: "No dispatcher activity yet",
    noChartData: "No data for this range",
  ...
  regions: {
    title: "Regions",
    subtitle: "Monitor water supply needs by city",
    top50: "Top {{count}} regions",
    searchPlaceholder: "Search cities...",
    totalRequests: "Total Requests",
    englishName: "English",
    persianName: "Persian",
    viewRequests: "View requests for this region",
